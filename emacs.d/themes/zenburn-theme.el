...
(defvar zenburn-colors-alist
  '(("zenburn-fg+1"     . "#FFFFFF")
    ...
    ("zenburn-red-3"    . "#DA4949")
    ("zenburn-red-4"    . "#DA4949")
    ("zenburn-orange"   . "#f3aa54")
    ("zenburn-yellow"   . "#fed669")
    ("zenburn-yellow-1" . "#fed660")
    ("zenburn-yellow-2" . "#fed660")
    ("zenburn-green-1"  . "#A5C261")
    ("zenburn-green"    . "#A5C261")
    ("zenburn-green+1"  . "#A5C261")
    ("zenburn-green+2"  . "#A5C261")
    ("zenburn-green+3"  . "#A5C261")
    ("zenburn-green+4"  . "#A5C261")
    ("zenburn-cyan"     . "#93E0E3")
...
;;;;; isearch
   ...
   `(mode-line
     ((,class (:foreground ,zenburn-fg
                           ...
                           :box (:line-width -1 :style released-button)))
      (t :inverse-video t)))
   `(mode-line-buffer-id ((t (:foreground ,zenburn-fg+1 :weight bold))))
   `(mode-line-inactive
     ((t (:foreground ,zenburn-fg-1
...
;;;;; ace-jump
   ...
   `(ace-jump-face-foreground
     ((t (:foreground ,zenburn-red :background ,zenburn-bg :inverse-video nil))))
;;;;; android mode
...
;;;;; company-mode
   ...
   `(company-tooltip-selection ((t (:foreground ,zenburn-fg :background ,zenburn-blue-5))))
   `(company-tooltip-mouse ((t (:background ,zenburn-bg-1))))
   `(company-tooltip-common ((t (:foreground ,zenburn-red))))
   `(company-tooltip-common-selection ((t (:foreground ,zenburn-red, :background ,zenburn-blue-5))))
   ...
   `(company-preview-common ((t (:foreground ,zenburn-red))))
;;;;; bm
...
;;;;; rainbow-delimiters
   `(rainbow-delimiters-depth-1-face ((t (:foreground ,zenburn-orange))))
